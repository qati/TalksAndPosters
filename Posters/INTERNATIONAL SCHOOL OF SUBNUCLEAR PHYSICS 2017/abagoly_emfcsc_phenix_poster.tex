...
\begin{minipage}{0.2\textwidth}%\baposter@titleimage@textwidth
  \begin{center}%
    \includegraphics[height=6.5em]{figs/emfcsc2}\\
     \vspace{0.001\textheight}
    \includegraphics[height=4.1em]{figs/logo_100}
...
\noindent \rule{0.9\textwidth}{1.2pt}\\ \vspace{-0.005\textheight}
	{\smaller Attila Bagoly (Eötvös University, Budapest) for the PHENIX Collaboration}\vspace{-0.01\textheight}
...
\bibitem{corehalo2}{T. Csörg\H{o} et al., Z.Phys. C71 (1996) 491}
\bibitem{fcpc}{T. Csörg\H{o}, Heavy Ion Physics 15 (2002) 1}
\end{thebibliography}\vspace{-0.0075\textheight}
\scriptsize
{A.B. was \includegraphics[scale=0.03]{figs/emmi_logo_h1} supported by the ÚNKP-16-2 New National Excellence program of the Ministry of Human Capacities}
}
